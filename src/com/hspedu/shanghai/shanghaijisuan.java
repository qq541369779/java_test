...
public class shanghaijisuan {
    ...
    public static double formula() {
        ...
        // 大于等于4小于7(包头不包尾) 系数1.2 .大于等于7 小于11 系数1.5 大于等于11 2,3以下为1
        double num = 0;
        if (block < 4 && block != 0) {
            num = 1;
        } else if (block >= 4 && block < 7) {
            num = 1.2;
        } else if (block >= 7 && block < 11) {
            num = 1.5;
        } else {
            num = 2;
        }
